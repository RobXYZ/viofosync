...
def _editable_values(snap) -> dict[str, Any]:
    ...
    return {
        ...
        "PRIMARY_SCOPE": snap.primary_scope,
        "PRIMARY_GPS_TRIAGE": snap.primary_gps_triage,
        "ALTERNATIVE_SCOPE": snap.alternative_scope,
        "ALTERNATIVE_GPS_TRIAGE": snap.alternative_gps_triage,
        "LOCATIONS": [
